package com.app.swagse.constants;
...
public class Variables {
    ...
    public static String outputflipped = app_folder + "outputflipped.mp4";
    public static String outputflipped2 = app_folder + "outputflipped2.mp4";

    public static boolean video_flipped = false;
   ...
   /* public static final String u_id = "u_id";
    ...
    public static String tag = "pikpok_";
    ...
    public static final String privacy_policy = "https://sites.google.com/view/ungliapp/home";

        public static final  String main_domain=Constants.BASE_URL;


    public static final String base_url = Constants.BASE_URL ; //main_domain + "API/";
    public static final String api_domain = base_url + Constants.PATH+"Apiutil/";//"index.php?p=";
