...
public class GamingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(GamingActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    public void getSwagTubeData() {
        if (App.isOnline()) {
            ...
            Call<SwagTubeResponse> userResponseCall = apiInterface.getTrendingCategoryData(PrefConnect.readString(GamingActivity.this, Constants.USERID, ""), "Gaming");
...
//                                swagTubeRecyclerView.setAdapter(swagTubeAdapter);
                        ...
                        try {
                            ...
                            toast(GamingActivity.this, jObjError.getString("response_msg"));
                        ...
                        OwnerGlobal.LoginRedirect(GamingActivity.this);
                    }
                }
    ...
    private RequestManager initGlide() {
        ...
        return Glide.with(GamingActivity.this)
