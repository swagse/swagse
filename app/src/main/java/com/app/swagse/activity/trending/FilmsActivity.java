...
public class FilmsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(FilmsActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    public void getSwagTubeData() {
        if (App.isOnline()) {
            ...
            Call<SwagTubeResponse> userResponseCall = apiInterface.getTrendingCategoryData(PrefConnect.readString(FilmsActivity.this, Constants.USERID, ""), "Movies");
...
//                                swagTubeRecyclerView.setAdapter(swagTubeAdapter);
                        ...
                        try {
                            ...
                            toast(FilmsActivity.this, jObjError.getString("response_msg"));
                        ...
                        OwnerGlobal.LoginRedirect(FilmsActivity.this);
                    }
                }
    ...
    private RequestManager initGlide() {
        ...
        return Glide.with(FilmsActivity.this)
