...
public class MusicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(MusicActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    public void getSwagTubeData() {
        if (App.isOnline()) {
            ...
            Call<SwagTubeResponse> userResponseCall = apiInterface.getTrendingCategoryData(PrefConnect.readString(MusicActivity.this, Constants.USERID, ""), "Music");
...
//                                swagTubeRecyclerView.setAdapter(swagTubeAdapter);
                        ...
                        try {
                            ...
                            toast(MusicActivity.this, jObjError.getString("response_msg"));
                        ...
                        OwnerGlobal.LoginRedirect(MusicActivity.this);
                    }
                }
    ...
    private RequestManager initGlide() {
        ...
        return Glide.with(MusicActivity.this)
