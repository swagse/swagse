package com.app.swagse.Chat.Audio;
...
public class SendAudio {
    ...
    public void UploadAudio(){
        ...
        Chat_Fragment.uploading_Audio_id=key;
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Chat_Fragment.uploading_Audio_id="none";
                            ...
                            public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                ...
                                Adduser_to_inbox.updateChildren(both_user_map).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        Chat_Fragment.SendPushNotification((Activity) context,Variables.user_name,"Send an Audio...",
                                                Variables.user_pic,
                                                Chat_Fragment.token,Receiverid,senderid);
