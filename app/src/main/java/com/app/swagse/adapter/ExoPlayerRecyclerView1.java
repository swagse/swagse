 ...
 * Author     : AndroidWave
 */
public class ExoPlayerRecyclerView1 extends RecyclerView {
    private static final String TAG = "ExoPlayerRecyclerView1";
     ...
     */
    // Media List
    private List<SwagtubedataItem> mediaObjects = new ArrayList<>();
    ...
    public ExoPlayerRecyclerView1(@NonNull Context context) {
        super(context);
        init(context);
    }

    public ExoPlayerRecyclerView1(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        TrendingViewHolder holder = (TrendingViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
    ...
    public void setMediaObjects(List<SwagtubedataItem> mediaObjects) {
