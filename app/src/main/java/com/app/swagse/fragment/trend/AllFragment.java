...
public class AllFragment extends Fragment {
    ...
    RecyclerView allTrendRecyclerView;
...
//        });
    ...
    public void getSwagTubeData() {
        if (App.isOnline()) {
            ...
            Call<SwagTubeResponse> userResponseCall = apiInterface.getSwagTubeData(PrefConnect.readString(getActivity(), Constants.USERID, ""));
